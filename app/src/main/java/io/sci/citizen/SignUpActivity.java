...
public class SignUpActivity extends BaseActivity {
    ...
    private TextInputLayout etUserName, etName, etEmail, etPassword, etAge, etAddress, etZipCode, etJob, etAffiliation;
    private AppCompatSpinner spGender, spEducation, spDistance;
    private LinearLayout tncLayout, pwdLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tncLayout.setOnClickListener(v -> showBottomSheetDialog());
    }
    ...
    private void signUp(){
        ...
        String fullName = etName.getEditText().getText().toString();
        if (fullName.isEmpty()){
        ...
        if (!StringUtils.isPasswordValid(password)) {
            etPassword.setError(getString(R.string.password_length_must_be_at_least_6_characters));
            return;
        }
        etPassword.setError("");
            ...
            public void onResponse(Call<Response> call, retrofit2.Response<Response> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    try {
                        ...
                        etUserName.setError(jObjError.getString("message"));
                    } catch (Exception ex) {
                        ex.printStackTrace();
                    }
                } else {
